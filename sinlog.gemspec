...
require_relative 'lib/sinlog/version'

Gem::Specification.new do |spec|
  spec.name = 'sinlog'
  spec.version = Sinlog::VERSION
  spec.authors = ['2moe']
  # spec.email = [""]

  spec.summary = 'colorful singleton logger'
  ...
  spec.files = IO.popen(%w[git ls-files -z], chdir: __dir__, err: IO::NULL) do |ls|
    ls.readlines("\x0", chomp: true).reject do |f|
      (f == gemspec) || f.start_with?(
        *%w[bin/ test/ spec/ features/ .git appveyor Gemfile Rakefile assets
            misc/
            docs/Readme-zh-
            .yardopts .rubocop.yml]
      )
    end
  end
  # spec.bindir = 'exe'
